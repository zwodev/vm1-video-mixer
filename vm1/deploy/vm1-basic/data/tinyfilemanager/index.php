...
$external = array(
    'css-bootstrap' => '<link href="tinyfilemanager/css/bootstrap.min.css" rel="stylesheet">',
    'css-dropzone' => '<link href="tinyfilemanager/css/dropzone.min.css" rel="stylesheet">',
    'css-font-awesome' => '<link rel="stylesheet" href="tinyfilemanager/css/font-awesome.min.css">',
    'css-highlightjs' => '<link rel="stylesheet" href="tinyfilemanager/css/default.min.css">', // Adjust if your style is different
    'js-ace' => '<script src="tinyfilemanager/js/ace.js"></script>',
    'js-bootstrap' => '<script src="tinyfilemanager/js/bootstrap.bundle.min.js"></script>',
    'js-dropzone' => '<script src="tinyfilemanager/js/dropzone.min.js"></script>',
    'js-jquery' => '<script src="tinyfilemanager/js/jquery-3.6.1.min.js"></script>',
    'js-jquery-datatables' => '<script src="tinyfilemanager/js/jquery.dataTables.min.js" defer></script>',
    'js-highlightjs' => '<script src="tinyfilemanager/js/highlight.min.js"></script>',
    'pre-jsdelivr' => '',
    'pre-cloudflare' => ''
);

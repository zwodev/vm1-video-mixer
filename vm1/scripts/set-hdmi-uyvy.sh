...
media-ctl -d /dev/media$MEDIADEVICE -V ''\''csi2'\'':0 [fmt:UYVY8_1X16/1920x1080 field:none]'
media-ctl -d /dev/media$MEDIADEVICE -V ''\''csi2'\'':4 [fmt:UYVY8_1X16/1920x1080 field:none]'
media-ctl -d /dev/media$MEDIADEVICE -V ''\''tc358743 11-000f'\'':0 [fmt:UYVY8_1X16/1920x1080]'

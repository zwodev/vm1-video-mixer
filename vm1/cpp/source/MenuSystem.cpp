...
void MenuSystem::handlePlaneSwitching()
{
    ...
    // switch output plane for Source or Control menu
    if (m_currentMenuType == MT_SourceMenu || 
        m_currentMenuType == MT_ControlMenu ) 
    {
        m_planeIdx = *id;
...
{
    m_ui.ShowMenuTitle("SRC/Shaders");

...
public:
    ...
    static std::string runCommand(const std::string& cmd) { return ""; };
    static std::string findAPConnection() { return ""; };
    static APCredentials getAPCredentials() { return APCredentials(); };
};